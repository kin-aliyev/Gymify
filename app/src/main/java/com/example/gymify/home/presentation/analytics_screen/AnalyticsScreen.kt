...
import com.example.gymify.home.presentation.analytics_screen.components.BmiCard
...
import com.example.gymify.home.presentation.analytics_screen.components.WorkoutActivityChart
    ...
    Scaffold(
        ...
        Column(
            ...
            WorkoutActivityChart(
                ...
                selectedDateTimestampTitle = state.selectedDateTimestamp,
    ...
    GymifyTheme {
        AnalyticsScreen(
            ...
            state = AnalyticsState(
                ...
                selectedDateTimestamp = 1720436400000L,
                totalTimeMinutes = 32,
                bmiValue = 25f,
            ),
            onAction = { }
